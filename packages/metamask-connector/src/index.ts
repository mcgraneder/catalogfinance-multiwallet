import { AbstractConnectorArguments, ConnectorUpdate } from '@catalogfinance-multiwallet/types'
import { AbstractConnector } from '@catalogfinance-multiwallet/abstract-connector'
